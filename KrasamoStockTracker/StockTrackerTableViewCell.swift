...
class StockTrackerTableViewCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        stockSymbol.font = UIFont.systemFont(ofSize: fontSize)
        stockSymbol.textColor = fontColor
        
        currentStockPrice.font = UIFont.systemFont(ofSize: fontSize)
        currentStockPrice.textColor = fontColor
        
        maximumStockPrice.font = UIFont.systemFont(ofSize: fontSize)
        maximumStockPrice.textColor = fontColor
        
        minimumStockPrice.font = UIFont.systemFont(ofSize: fontSize)
